<template>
  <div class="my-node">
    ...
    <div class="div-icon1 node-page-top">
      ...
      <ul>
        <li class="li-bg overflow">
          <label>{{$t('message.c16')}}：</label>{{this.agentAddressInfo.agentName ? this.agentAddressInfo.agentName :
          this.agentAddressInfo.agentAddresss}}
    ...
    <div class="my-node-bottom">
      ...
      <el-pagination layout="prev, pager, next" :page-size="10" :total=this.total
                     v-show="totalOK = this.total > 10 ? true:false" @current-change="myMortgageSize"
