...
const cn = {
  message: {
    ...
    c2021:'对不起，转账金额不能大于可用余额',

    c203:'高级选项',
    c204:'请输入GasLimit：1-10000000',
    c205:'请输入Price',
    c206:'GasLimit较小，有可能会导致该操作执行失败',
    c207:'资产类型',
    c208:'全部资产',
    c209:'全部交易',
    c210:'总费用',
    ...
    tip1:'此账户没有设置密码，确定执行该操作么',
    // 点击【取消收藏】时的弹框提示信息
    tips2:'此合约将从我的合约中移除，确定执行该操作么',
    // 高级选项里最后一个输入框的标签
    tips3:'附加信息',
    // 合约基本信息的字段
    tips4:'余额',
